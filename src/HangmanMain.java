...
class HangmanGame {
    ...
    public void displayHangman(int difficultyLevel) {
        ...
        int startingStage = (difficultyLevel == 1)
                ? 0
                : (difficultyLevel == 2) ? 2 : 4;
    ...
    public boolean makeGuess(char letter) {
        ...
        for (int i = 0; i < selectedWord.length(); i++) {
            if (selectedWord.charAt(i) == letter) {
                ...
                System.out.println(
                        "Correct Guess. Remaining Attempts : " + remainingAttempts);
            }
        }
        ...
        if (!letterGuessed) {
            ...
            playWrongGuessSound();
            System.out.println(
                    "Wrong guess. Remaining attempts: " + remainingAttempts);
        }
    ...
    private void initAudio() {
        try {
            ...
            AudioInputStream correctGuessStream = AudioSystem.getAudioInputStream(
                    new File("correct_guess.wav"));
            ...
            AudioInputStream wrongGuessStream = AudioSystem.getAudioInputStream(
                    new File("wrong_guess.wav"));
                ...
                switch (choice) {
                    case 1:
                        ...
                        PreparedStatement selectStatement = connection.prepareStatement(
                                "SELECT wins FROM leaderboard WHERE username = ?");
                        ...
                        if (game.isGameWon()) {
                            ...
                            System.out.println(
                                    "Game over! The word was: " + game.getSelectedWord());
                    ...
                    case 2:
                        ...
                        PreparedStatement p_statement = connection.prepareStatement(
                                "SELECT username, wins FROM leaderboard");
